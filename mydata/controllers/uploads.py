...
class UploadDatafileRunnable(object):
    ...
    def Run(self):
        ...
        try:
            ...
            elif foldersController.uploadMethod == \
    ...
    def Md5ProgressCallback(self, bytesSummed):
        ...
        DATAVIEW_MODELS['uploads'].UploadProgressUpdated(self.uploadModel)
        if size >= (1024 * 1024 * 1024):
            message = "%3.1f %%  MD5 summed" % percentComplete
        else:
            message = "%3d %%  MD5 summed" % int(percentComplete)
        DATAVIEW_MODELS['uploads'].SetMessage(self.uploadModel, message)
    ...
    def UploadFileWithPost(self, dataFileDict):
        ...
        try:
            DataFileModel.UploadDataFileWithPost(
    ...
    def UploadFileToStaging(self, dataFileDict):
        ...
        # while uploading a zero-byte file, we don't want to mark it
